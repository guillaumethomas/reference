...
class Vertex:
    ...
    def __gt__(self, Vertex):
        if self.distance > Vertex.distance:
            return self
        return Vertex
    ...
    def __str__(self):
        ret_str = '{} adjacent {}'.format(str(self.id),
    ...
    while len(unvisited_queue):
        ...
        for next in current.adjacent:
            ...
            if new_dist < next.get_distance():
                ...
                to_print = ['', current.get_id(),
                            next.get_id(), next.get_distance()]
            else:
                to_print = ['not ', current.get_id(),
                            next.get_id(), next.get_distance()]

            print_str = '{}updated : current = {} next = {} \
                         new_dist = {}'.format(*to_print)
            print(print_str)
